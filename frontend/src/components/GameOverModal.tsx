  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-8 max-w-2xl max-h-[80vh] overflow-y-auto border border-gray-200">
        <h2 className="text-2xl font-semibold text-center mb-6">💀 Game Over!</h2>
        
        <div className="bg-gray-100 p-4 rounded-lg mb-6 text-center">
          <p className="mb-2">Wave Reached: <span className="font-medium">{wave}</span></p>
          <p className="mb-2">XP Earned: ⭐<span className="font-medium">{xp}</span></p>
          <p>Total XP: ⭐<span className="font-medium">{xp}</span></p>
        </div>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm text-gray-500 ml-auto">Lv.{level}</span>
                </div>
