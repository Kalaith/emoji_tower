...
export const GameCanvas: React.FC = () => {
    ...
    (ctx: CanvasRenderingContext2D) => {
      if (!gameMap) {
        ...
        ctx.fillRect(
          0,
          0,
          gameData.gameSettings.canvasWidth,
          gameData.gameSettings.canvasHeight,
        );
        ctx.fillStyle = "black";
        ctx.font = "20px Arial";
        ...
        ctx.fillText(
          "Loading map...",
          gameData.gameSettings.canvasWidth / 2,
          gameData.gameSettings.canvasHeight / 2,
        );
        return;
      }
  ...
  const drawProjectiles = useCallback(
    (ctx: CanvasRenderingContext2D) => {
